                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text25">
                        We start by understanding your goals and objectives
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text28">
                        ...
                        tailored to your specific needs and target audience.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text26">
                        We execute the strategy with precision and attention to
                        detail to ensure a successful marketing campaign.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text31">
                        After the campaign, we analyze the results and optimize
                        the approach for future success.
                      </span>
                    </Fragment>
                  )}
                </span>
